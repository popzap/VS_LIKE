...
| 2026-08-30 | DEV | `열림` | **무기 SFX 2종 배선 끝**(대조 Fire=0/Cast=0). `TUNING.md` §2 C-2 에 실측 등재 + 🔴 **검 `DUR` 상한 0.247s** + 소환수 SFX 요청 — 아래 §요청-8 | [`DONE/D14.md`](../DONE/D14.md) · [`REQ/DEV.md` 요청-12](DEV.md) |
