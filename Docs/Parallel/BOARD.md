...
| DEV | `D38` | `Docs/Parallel/REQ/**` · `Docs/{TODO,ROADMAP}.md` | 2026-09-04 | `진행중` — **`C32` 순서를 받는다** (사용자 결정 A). 요청-27(보스 그림)을 **보류로 낮추고** `DESIGN_ART.md` §6 의 1~5번을 먼저 받는다 — DEV 는 **배선만**. 🔴 곁일: `C32` §7 정리 후보 3개의 **참조를 guid 로 실측** — `Exp_Orb.gif` 는 지우면 안 된다 |
...
|---|---|
| 상태 | `BUSY` |
| 점유 이슈 | `D38` (C32 순서 수용 · 요청-27 보류 · 정리 후보 참조 실측) |
